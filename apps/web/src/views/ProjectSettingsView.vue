  ...
  <div class="h-full flex flex-col overflow-y-auto bg-bg-page p-8">
    <header class="mb-8 flex items-center justify-between">
      ...
      <div class="flex gap-3">
        <NButton class="text-red-500 hover:bg-red-50" variant="ghost" @click="showDeleteConfirm = true">
          <Trash2 class="mr-2" :size="16" />
          删除项目
        </NButton>
        <NButton :loading="saving" variant="primary" @click="handleSaveProject">
    ...
    <div v-if="!loading" class="mx-auto max-w-4xl w-full space-y-8">
      <!-- Basic Info Section -->
