...
- API：46 个测试文件、245 条测试；语句/行 80.44%，分支 72.62%，函数 91.02%。
- Eventing：语句/行 98.01%，分支 91.19%，函数 97%；Process Manager 为 100%。
- Web：12 个测试文件、35 条测试；语句/行 84.5%，分支 67.4%，函数 61.13%。
